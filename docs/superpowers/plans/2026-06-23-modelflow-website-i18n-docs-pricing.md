...
<article class="pricing-card pricing-card-popular" data-pricing-card="pro">
  ...
  <a class="btn btn-cta pricing-btn" id="pro-btn" href="https://apps.microsoft.com/detail/9PKVZ235H6TD" target="_blank" rel="noopener" data-i18n="pricing.proMonthlyBtn">Start 7-Day Free Trial</a>
</article>
```
